        ...
        <div className="space-y-8 relative mt-12 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-white">
          {roadmap.map(({ title, desc, img }, i) => {
            return (
              <div
                key={i}
                className="even:ml-auto w-1/2 relative flex items-center justify-between  md:even:flex-row-reverse group is-active"
              >
                ...
                <div className="relative roadmap-item w-4/5 shadow-inner p-8 rounded-2xl shadow flex gap-4">
                  ...
                  <div>
                    ...
                    <div className=" text-lg font-light font-medium">{desc}</div>
                  </div>
                </div>
