        ...
        <section className="relative text-white min-h-screen py-32">
            ...
            <Container>
                <div className="flex gap-16 bg-neutral-950 px-8 mb-8 rounded-lg relative overflow-hidden">
                    ...
                    {tabs.map(tab => {
                        return <button onClick={() => setSelectedTab(tab.id)} className={`font-medium bg-transparent py-6 border-b border-b-[4px] border-transparent duration-200 ${selectedTab == tab.id ? "text-neutral-100 border-white" : "text-neutral-400"}`}>
                            {tab.label}
                        </button>
                    })}
                </div>
                        ...
                        <div className="bg-neutral-950 p-8 relative overflow-hidden rounded-lg flex-1">
                            ...
                            <div className="flex gap-16 items-center">
                                ...
                                <div className="flex flex-col gap-1 items-center">
                                    <p className="text-xs font-medium text-neutral-400">Available now</p>
                ...
                <div className="bg-neutral-950 p-8 rounded-lg overflow-hidden">
                    <VestingSchedule />
                </div>
            </Container>
